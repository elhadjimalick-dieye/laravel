...
<div style="background-color:#F0F8FF ;margin-left:5%" class="col-xs-12 col-sm-12 col-md-11" >
    <strong>Matricule: </strong> {{ $client->matricule }}
    
    </div>
<br>
    <div style="background-color:#F0F8FF ;margin-left:5%" class="col-xs-12 col-sm-12 col-md-11">
    <span><strong>Adresse: </strong> {{ $client->adresse }}</span>
    </div>
    <br>
    <div style="background-color:#F0F8FF ;margin-left:5%" class="col-xs-12 col-sm-12 col-md-11" >
    ...
    <br>
    <div style="background-color:#F0F8FF ;margin-left:5%" class="col-xs-12 col-sm-12 col-md-11">
    <strong>Montant totale acheter: </strong> {{ $client->totaleachete }} FCFA
    </div>
    <br>
    <div style="background-color:#F0F8FF ;margin-left:5%" class="col-xs-12 col-sm-12 col-md-11">
    <strong>Créance:   {{ $client->creance }} FCFA
    </div>
    <br>
    <div style="background-color:#F0F8FF ;margin-left:5%" class="col-xs-12 col-sm-12 col-md-11">
    <strong>Restant du: </strong> {{ $client->restant_du }} FCFA
 </div>
 <br>
  </div>
</div>
