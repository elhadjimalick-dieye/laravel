...
<div class="card col-xs-12 col-sm-12 col-md-11 " style="margin-left:5%">
    <div class="card-header" style="background-color:green;color:white">
        {{ trans('Formulaire de sechage des matieres') }}
    </div>
<br>



{!! Form::model($sechage, ['method' => 'PATCH','route' => ['sechages.update', $sechage->id]]) !!}
...
<div class="col-xs-12 col-sm-12 col-md-5 " >
    ...
    <div class="col-xs-12 col-sm-12 col-md-5 " >
        <div class="form-group">
            ...
            {!! Form::number('sechage', null, array('placeholder' => 'quantite en kg','disabled','class' => 'form-control')) !!}
        </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-5 " >
        <div class="form-group">
            ...
            {!! Form::number('effectifsec', null, array('placeholder' => 'nombre de personne','class' => 'form-control')) !!}
        </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-5 " >
        <div class="form-group">
            ...
            {!! Form::number('dechesechage', null, array('placeholder' => 'quantite en kg','class' => 'form-control')) !!}
        </div>
...
<div class="col-xs-12 col-sm-12 col-md-10 card-header" style="background-color:#008B8B;color:white" >
    ...
    <div class="col-xs-12 col-sm-12 col-md-10 card-header" style="background-color:green;color:white">
        ...
        <div class="form-group">
            <strong style='color:blue'> Couleur Bleu</strong>
            {!! Form::number('petprefombleu', null, array('placeholder' => 'quantite en kg','class' => 'form-control')) !!}
        </div>
      
    </div> <div class="col-xs-12 col-sm-12 col-md-5 " >
        <div class="form-group">
            <strong style='color:black'> Couleur Blanc</strong>
            {!! Form::number('petprefomblanc', null, array('placeholder' => 'quantite en kg','class' => 'form-control')) !!}
        </div>
