...
<div class="card col-xs-12 col-sm-12 col-md-11 " style="margin-left:5%">
    <div class="card-header" style="background-color:green;color:white">
        {{ trans('Formulaire de mise en sac des matieres') }}
    </div>
<br>


{!! Form::model($sac, ['method' => 'PATCH','route' => ['sacs.update', $sac->id]]) !!}
...
<div class="col-xs-12 col-sm-12 col-md-5" >
    ...
    <div class="col-xs-12 col-sm-12 col-md-5 " >
        <div class="form-group">
            ...
            {!! Form::number('effectifsac', null, array('placeholder' => 'nombre de personne','class' => 'form-control')) !!}
        </div>
