...
<div class="row " style="margin-left:8%">
    <div class="col-lg-8 ">
        ...
        <div class="pull-right">
            <a class="btn btn-success" href="{{ route('sacs.create') }}"> Retour</a>
        </div>
        <br>
...
{!! Form::model($stock, ['method' => 'PATCH','route' => ['stockproduitfinis.showedit', $stock->id]]) !!}
...
<div class="col-xs-12 col-sm-12 col-md-3 " >
    ...
    <div class="col-xs-12 col-sm-12 col-md-3 " >
        <div class="form-group">
            ...
            {!! Form::number('extrude', null, array('placeholder' => 'quantite en kg','disabled','class' => 'form-control')) !!}
        </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-2 " >
        <div class="form-group">
            ...
            {!! Form::number('dechesac', null, array('placeholder' => 'quantite en kg','class' => 'form-control')) !!}
        </div>
