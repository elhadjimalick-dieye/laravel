...
<div class="row " style="margin-left:8%">
    <div class="col-lg-8 ">
        <div class="pull-left">
            <h2>Formulaire de lavage hors circuits </h2>
        </div>
...
<div class="card col-xs-12 col-sm-12 col-md-11 " style="margin-left:5%">
    <div class="card-header" style="background-color:green;color:white">
        {{ trans('Formulaire de lavage hors circuits des matieres') }}
    </div>
<br>


{!! Form::model($lavagehor, ['method' => 'PATCH','route' => ['lavageshors.update', $lavagehor->id]]) !!}
...
<div class="col-xs-12 col-sm-12 col-md-5 " >
    ...
    <div class="col-xs-12 col-sm-12 col-md-5 " >
        <div class="form-group">
            ...
            {!! Form::number('lavagehor', null, array('placeholder' => 'quantite en kg','disabled','class' => 'form-control')) !!}
        </div>
